...
from parser import audioSources, init_parser
from get_corners import pick_point_in_image, parse_corners_file
...
def main():
    ...
    if args.corners_screen is not None and args.corners_image is not None:
        args.corners_screen, ref_img = parse_corners_file(args.corners_screen,
                                                          args.corners_image)
    else:
